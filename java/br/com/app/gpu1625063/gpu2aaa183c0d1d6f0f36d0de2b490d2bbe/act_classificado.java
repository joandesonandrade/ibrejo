...
public class act_classificado extends AppCompatActivity {

    private RecyclerView rv;
    private String url_event = "http://app.informabrejo.com.br/classificado.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_act_classificado);


        getSupportActionBar().setTitle("Classificados");
    ...
    void  initError(){
        TextView txtError = (TextView)findViewById(R.id.classificado_erro);
        ProgressBar pbar = (ProgressBar)findViewById(R.id.progress_classificado);
    ...
    void initEvent(List<empresa> lst){
        ProgressBar pbar = (ProgressBar)findViewById(R.id.progress_classificado);
        pbar.setVisibility(View.GONE);
        rv = (RecyclerView)findViewById(R.id.rv_classificado);
